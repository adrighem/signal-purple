...
signal_get_info(PurpleConnection *gc, const char *who)
{
    ...
    purple_notify_user_info_add_pair_plaintext(
        info, "Safety number",
        "Not exposed by this build; verify sensitive chats in an official Signal client.");
...
static PurplePluginProtocolInfo protocol_info = {
    ...
    .icon_spec = { "png,jpeg,gif", 0, 0, 2048, 2048, 10 * 1024 * 1024,
    ...
    .get_cb_alias = signal_chat_buddy_alias,
...
static PurplePluginInfo plugin_info = {
    ...
    .summary = "Signal protocol for libpurple 2",
    .description =
